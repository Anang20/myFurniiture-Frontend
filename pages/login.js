...
import imageLogin from '../public/images/authentication.png'
                                ...
                                <div className="col-lg-7">
                                    <div className="p-5">
                                        <div className="text-center">
                                            <h1 className="h4 text-gray-900 mb-2">Masuk</h1>
                                        </div>
                                        <form action="" method="POST">
                                            ...
                                            <div className="d-grid gap-2">
                                                <button type="submit" style={{ borderRadius: 15 }} className="btn btn-success btn-user btn-block mt-4">Login</button>
                                                <center>
                                                    <p>Belum Punya Akun? <a href="" style={{ color: "00B8B0" }}>Daftar</a></p>
                                                </center>
                                            </div>
                                        </form>
                                    </div>
